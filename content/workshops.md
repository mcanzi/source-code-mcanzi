...
My workshops can be tailored to different levels of expertise (from first encounters with R to advanced visualisation and modelling), different durations (from a single afternoon to a full week), and different disciplinary backgrounds. If you are interested in arranging a workshop for your department, research group, or institution, feel free to get in touch.  

Since 2022, I have designed and delivered workshops on quantitative methods, data manipulation, and data visualisation across a range of institutions and audiences.   
